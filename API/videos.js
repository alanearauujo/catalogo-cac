...
export default async function handler(req, res) {
    ...
    if (!API_KEY || !CHANNEL_ID) {
        return res.status(500).json({ erro: "Variáveis de ambiente ausentes no servidor." });
    }
    ...
    try {
        ...
        const videosFormatados = dados.items.map(item => {
            ...
            // CORREÇÃO AQUI: Agora o valor padrão é explicitamente uma String "20260101" entre aspas
            ...
            return {
                ...
                data: String(dataFormatada), // Garante 100% que vai como texto para o frontend
                tags: tagAssociada 
            };
        });
        ...
        return res.status(500).json({ erro: 'Falha crítica na comunicação com o YouTube' });
    }
}